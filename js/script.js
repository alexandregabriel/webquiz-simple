// Time part 2 54:00 - https://www.youtube.com/watch?v=WUBhpSRS_fk&ab_channel=CodingNepal
...
function showResultBox(){
    ...
    if(userScore > 3){
        ...
        let scoreTag = '<span>Me desculpe, você acertou só <p>'+  userScore  +'</p> de<p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
